...
a549 = pd.read_excel("./Data/a549_data_ox.xlsx", sheet_name=0, index_col=0)
beas = pd.read_excel("./Data/beas_data_ox.xlsx", sheet_name=0, index_col=0)
hep72 = pd.read_excel("./Data/hepg2_data_ox.xlsx", sheet_name=0, index_col=0)
