...
# Load Data
X = pd.read_excel(
    "./Data/My_Selected_X_srednia_vertical.xlsx", sheet_name=0, index_col=0
)
...
ts2 = 4.5
cv_t = 0.85
filename = "./FiltredModels/filtred_mean_vertical.txt"
...
while num < cycle:
    ...
    randnum = find_train(X_train, y_train, randInt=10000, treshold=ts1)
